#ifndef LLIB_CONSISTENT_QUEUE_HPP
#define LLIB_CONSISTENT_QUEUE_HPP
...
namespace llib {
     ...
     * The 'consistent' in the name refers to the fact that the memory
     * of the queue is used like an actual queue (e.g. always in order).
     *
    ...
    public:
         ...
         * Default constructor.
         */
        constexpr consistent_queue() = default;
         ...
         * @param other
         */
        constexpr consistent_queue(const consistent_queue &other) {
            store = other.store;
        }
         ...
         * @param other
         */
        constexpr consistent_queue(consistent_queue &&other) noexcept {
         ...
         * @return
         */
        constexpr void swap(consistent_queue &other) noexcept {
