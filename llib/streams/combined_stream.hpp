#ifndef LLIB_COMBINED_STREAM_HPP
#define LLIB_COMBINED_STREAM_HPP
...
namespace llib {
     ...
     * @tparam Ostream
     */
    template<typename S1, typename S2, typename Ostream = llib::ostream<>>
...
#endif //LLIB_COMBINED_STREAM_HPP
